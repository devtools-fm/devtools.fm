---
title: Dax Raad - SST
description: "This week we talk with Dax Raad about SST, a framework for building serverless applications on AWS. SST is a typescript framework that makes it easy to build serverless applications on AWS. It's built on top of the AWS CDK, but provides a much nicer developer experience. ax also presents a critique of cloud service providers and a call for more open source knowledge."
...
atUri: "at://did:plc:m2sjv3wncvsasdapla35hzwj/site.standard.document/3mnv66qq2bs2s"
