...
description: "This week we talk to Artem Zakharchenko, the creator of Mock Service Worker (MSW). MSW is a library that allows you to mock network requests in your tests and demos. We talk about the evolution of MSW, the technical details of how it works, and the future prospects of the library."
spotify: https://creators.spotify.com/pod/show/devtoolsfm/episodes/Artem-Zakharchenko---Mock-Service-Worker-e2tn3gv
atUri: "at://did:plc:m2sjv3wncvsasdapla35hzwj/site.standard.document/3mnv66kpuqt2n"
