---
title: Predrag Gruevski - Trustfall, Cargo Semver Checks, and the Future of Query-Based Tools
description: "This week we have Predrag Gruevski to discuss Trustfall, a new query-based tool for querying anything. Trustfall makes it simple to turn anything into queryable data. Predrag used that to create cargo-semver-checks, a tool that checks your Rust packages for semantic versioning compliance."
...
atUri: "at://did:plc:tnliqml7jfchh6dltyi2senj/site.standard.document/3mnv6xtavd32e"
...
Trustfall makes it simple to turn anything into queryable data.
