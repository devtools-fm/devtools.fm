...
description: "This week we dive into a fascinating new concept in web development: Module Federation. Join us with Zack Jackson, the creator of module federation, to discuss where it started, how it works, and all the cool uses cases it unlocks."
youtube: https://www.youtube.com/watch?v=XpeD4FtlMg4
spotify: https://podcasters.spotify.com/pod/show/devtoolsfm/episodes/Zack-Jackson---Module-Federation-e2134gm
atUri: "at://did:plc:m2sjv3wncvsasdapla35hzwj/site.standard.document/3mnv66w22pk2s"
