...
description: "This week we're delighted to have Nicholas Zakas on the show to talk about ESLint. ESLint is a tool that helps you find and fix problems in your JavaScript code by writing plugins that check for patterns in your code's AST. We talk about the history of ESLint, the challenges of building a linter, and the future of of ESLint."
spotify: https://podcasters.spotify.com/pod/show/devtoolsfm/episodes/Nicholas-C--Zakas---ESLint-e2mqm4l
atUri: "at://did:plc:m2sjv3wncvsasdapla35hzwj/site.standard.document/3mnv66msrm42i"
