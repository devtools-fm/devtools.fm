...
description: "Nicholas C. Zakas discusses ESLint's evolution, the new FlatConfig system, and ambitious plans to rewrite the core linting engine from scratch."
