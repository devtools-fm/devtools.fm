...
description: "This week we're joined by Colin McDonnell, the head of devrel at EdgeDB a relational database with an object-oriented data model and a powerful query language. Colin is also the creator of useful TypeScript libraries such as Zod and tRPC."
...
atUri: "at://did:plc:m2sjv3wncvsasdapla35hzwj/site.standard.document/3mnv66vx7cx2l"
