...
description: "This week we talk to David Blass, the creator of ArkType, a runtime validation library for TypeScript. ArkType goes against the mold of other TypeScript validation libraries by using a syntax that is as close to native TypeScript as possible. It's packed with interesting features and has made David a TypeScript performance expert."
...
atUri: "at://did:plc:m2sjv3wncvsasdapla35hzwj/site.standard.document/3mnv66k7xxl2n"
