...
description: "This week we're delighted to welcome Sam Goodwin to the show. Sam is the creator of Alchemy, a tool that allows you to create and manage your infrastructure as code. The current state of the art is built on all the tech debt of the past 10 years, Alchemy is a new approach to infrastructure as code that is more aligned with the modern web."
...
atUri: "at://did:plc:m2sjv3wncvsasdapla35hzwj/site.standard.document/3mnv66jky5b26"
