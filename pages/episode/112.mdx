...
description: "Travis Arnold demonstrates OmniDoc's type-checked documentation system and discusses performance optimization in his React-based UI libraries."
spotify: https://podcasters.spotify.com/pod/show/devtoolsfm/episodes/Travis-Arnold---Omnidoc--Restyle--JSX-UI-e2nsp4f
atUri: "at://did:plc:tnliqml7jfchh6dltyi2senj/site.standard.document/3mnv6xtdsv52k"
...
**Travis:** the new latest product I've been working on is called OmniDoc. And that really is a solution for documentation for JavaScript, uh, code basis specifically, or TypeScript, if you're using TypeScript, um, and that allows you to build a fully customized documentation solution.​
