---
title: Norbert de Langen and Dominic Nguyen - Storybook
description: "Storybook is an open source tool for building UI components in isolation. Tune in as we talk to [Dominic Nguyen](https://twitter.com/domyen) and [Norbert de Langen](https://twitter.com/NorbertdeLangen) about the story behind storybook, what it's like to run an open-source based company, the importance of developing UI in isolation, and more."
youtube: https://www.youtube.com/watch?v=Uu1p3bCgRNI
spotify: https://podcasters.spotify.com/pod/show/devtoolsfm/episodes/Storybook-with-Norbert-and-Dom-e2134gi
publishDate: 2021-06-03
atUri: "at://did:plc:m2sjv3wncvsasdapla35hzwj/site.standard.document/3mnv66yipdi2y"
---
...
- [Pheonix LiveView](https://github.com/phoenixframework/phoenix_live_view)
- [Meteor's DDP](https://github.com/meteor/meteor/blob/devel/packages/ddp/DDP.md)
...
- [Story Docs](https://storybook.js.org/docs/react/writing-docs/introduction)
