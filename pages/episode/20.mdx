...
description: "This weeks guest is Simon Hoffman an engineer with passion to Automate All the Things™. Simon is pioneering the way in a new desktop automation library called Nut.js, which works on all OSes and has intuitive thoughtful API."
...
atUri: "at://did:plc:tnliqml7jfchh6dltyi2senj/site.standard.document/3mnv6ybkcyn2h"
