...
description: "Steve Manuel and Ben Eckel from Dylibso explore Extism, their WebAssembly-powered extension framework that's bridging the gap in modern app architecture."
